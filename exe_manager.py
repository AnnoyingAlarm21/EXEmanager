...
class WineExeManager(QMainWindow):
    ...
    def set_application_style(self):
        # Set global application style with lighter, cozier colors
        self.setStyleSheet("""
            QMainWindow {
    ...
    def launch_selected(self):
        ...
        if not selected_items or not selected_items[0].data(Qt.UserRole) is None:
            QMessageBox.information(self, "Select an EXE", "Please select an EXE to launch")
            return
